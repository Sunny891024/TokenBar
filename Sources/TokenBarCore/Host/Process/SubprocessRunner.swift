...
public enum SubprocessRunnerError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case let .binaryNotFound(binary):
            return "Missing CLI '\(binary)'. Install it and restart TokenBar."
...
public enum SubprocessRunner {
    private static let log = TokenBarLog.logger(LogCategories.subprocess)
    private static let timeoutQueue = DispatchQueue(
        label: "com.tokenbar.tokenbar.subprocess.timeout",
        qos: .userInitiated,
