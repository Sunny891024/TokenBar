...
public struct TokenBarConfig: Codable, Sendable {
    ...
    public static func makeDefault(
        metadata: [UsageProvider: ProviderMetadata] = ProviderDescriptorRegistry.metadata) -> TokenBarConfig
    {
        ...
        return TokenBarConfig(version: Self.currentVersion, providers: providers)
    }
