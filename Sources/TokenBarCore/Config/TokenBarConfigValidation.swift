...
public enum TokenBarConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct TokenBarConfigIssue: Codable, Sendable, Equatable {
    public let severity: TokenBarConfigIssueSeverity
    ...
    public init(
        severity: TokenBarConfigIssueSeverity,
...
public enum TokenBarConfigValidator {
    ...
    public static func validate(_ config: TokenBarConfig) -> [TokenBarConfigIssue] {
        var issues: [TokenBarConfigIssue] = []

        if config.version != TokenBarConfig.currentVersion {
            issues.append(TokenBarConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [TokenBarConfigIssue]) {
    ...
    private static func validateSecretKey(_ entry: ProviderConfig, issues: inout [TokenBarConfigIssue]) {
    ...
    private static func validateRegion(_ entry: ProviderConfig, issues: inout [TokenBarConfigIssue]) {
        let provider = entry.id
    ...
    private static func validateKnownRegion(
        ...
        isValid: Bool,
        displayName: String,
        issues: inout [TokenBarConfigIssue])
    {
