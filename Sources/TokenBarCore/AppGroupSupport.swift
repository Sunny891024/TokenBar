...
public enum AppGroupSupport {
    ...
    public static let legacyReleaseGroupID = "group.com.tokenbar.tokenbar"
    public static let legacyDebugGroupID = "group.com.tokenbar.tokenbar.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.tokenbar.tokenbar"
