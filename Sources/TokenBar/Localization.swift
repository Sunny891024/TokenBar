...
enum TokenBarLocalizationOverride {
...
func tokenBarLocalizationResourceBundle(
...
private func localizedBundle() -> Bundle {
    let resourceBundle = tokenBarLocalizationResourceBundle()
    let language = TokenBarLocalizationOverride.appLanguage ?? appLanguageDefaults().string(forKey: "appLanguage") ?? ""
    if !language.isEmpty {
...
func L(_ key: String) -> String {
    let resourceBundle = tokenBarLocalizationResourceBundle()
    return tokenBarLocalizedString(key, bundle: localizedBundle(), resourceBundle: resourceBundle)
}
...
func tokenBarLocalizedLocale() -> Locale {
...
func tokenBarLocalizedString(_ key: String, bundle: Bundle, resourceBundle: Bundle) -> String {
