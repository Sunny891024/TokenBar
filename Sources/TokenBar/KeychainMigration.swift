...
enum KeychainMigration {
    private static let log = TokenBarLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.tokenbar.TokenBar", account: "codex-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "claude-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "cursor-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "factory-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "minimax-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "minimax-api-token"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "augment-cookie"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "copilot-api-token"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "zai-api-token"),
        MigrationItem(service: "com.tokenbar.TokenBar", account: "synthetic-api-key"),
    ]
