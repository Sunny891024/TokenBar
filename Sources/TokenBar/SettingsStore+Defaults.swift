...
extension SettingsStore {
    ...
    var isVerboseLoggingEnabled: Bool {
        self.debugLogLevel.rank <= TokenBarLog.Level.verbose.rank
    }
    ...
    private var claudeWebExtrasEnabledRaw: Bool {
        ...
        set {
            ...
            TokenBarLog.logger(LogCategories.settings).info(
