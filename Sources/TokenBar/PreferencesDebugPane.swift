        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: L("section_logging")) {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        Picker("Verbosity", selection: self.$settings.debugLogLevel) {
                            ForEach(TokenBarLog.Level.allCases) { level in
                    ...
                    Button {
                        NSWorkspace.shared.open(TokenBarLog.fileLogURL)
                    } label: {
                    ...
                    caption: L("loading_animations_caption"))
                {
                    ...
                    Button {
                        NotificationCenter.default.post(name: .tokenbarDebugBlinkNow, object: nil)
                    } label: {
