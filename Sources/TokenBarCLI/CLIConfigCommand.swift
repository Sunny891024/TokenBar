...
extension TokenBarCLI {
    ...
    static func configSettingAPIKey(
        _ config: TokenBarConfig,
        provider: UsageProvider,
        apiKey: String,
        enableProvider: Bool) -> TokenBarConfig
    {
    ...
    static func configProviderStatuses(_ config: TokenBarConfig) -> [ConfigProviderStatusResult] {
