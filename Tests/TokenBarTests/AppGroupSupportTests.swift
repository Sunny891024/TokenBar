...
struct AppGroupSupportTests {
    ...
    func `app group identifiers use resolved team-prefixed release and debug variants`() {
        #expect(
            AppGroupSupport.currentGroupID(teamID: "Y5PE65HELJ", bundleID: "com.tokenbar.tokenbar")
                == "Y5PE65HELJ.com.tokenbar.tokenbar")
        #expect(
            AppGroupSupport.currentGroupID(teamID: "ABCDE12345", bundleID: "com.tokenbar.tokenbar.debug")
                == "ABCDE12345.com.tokenbar.tokenbar.debug")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.tokenbar.tokenbar")
                == "group.com.tokenbar.tokenbar")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.tokenbar.tokenbar.debug")
                == "group.com.tokenbar.tokenbar.debug")
    }
    ...
    func `legacy migration copies snapshot once`() throws {
        ...
        let result = AppGroupSupport.migrateLegacyDataIfNeeded(
            bundleID: "com.tokenbar.tokenbar",
