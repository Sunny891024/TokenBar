...
struct OpenAIDashboardWebViewCacheTests {
    ...
    func `Reused page reset clears one shot scraper globals`() async throws {
        ...
        _ = try await lease.webView.evaluateJavaScript(
            ...
            window.__tokenbarUsageBreakdownJSON = '[{"day":"2026-04-19"}]';
            window.__tokenbarUsageBreakdownDebug = 'debug';
            true;
            """)
        ...
        let reset = try await lease.webView.evaluateJavaScript(
            """
            typeof window.__tokenbarDidScrollToCredits === 'undefined' &&
            typeof window.__tokenbarUsageBreakdownJSON === 'undefined' &&
            typeof window.__tokenbarUsageBreakdownDebug === 'undefined'
            """) as? Bool
