...
struct StatusItemControllerSplitLifecycleTests {
    ...
    func `status items publish stable non persistent manager identity`() throws {
        ...
        #expect(!controller.statusItem.autosaveName.hasPrefix("TokenBar."))
        #expect(controller.statusItems[.codex]?.autosaveName.hasPrefix("TokenBar.") == false)
        #expect(controller.statusItems[.claude]?.autosaveName.hasPrefix("TokenBar.") == false)
    ...
    func `status item defaults repair removes stale hidden Control Center keys once`() throws {
        ...
        defaults.set(false, forKey: "NSStatusItem VisibleCC tokenbar-merged")
        ...
        #expect(repairedKeys == [
            ...
            "NSStatusItem VisibleCC tokenbar-merged",
        ])
        ...
        #expect(defaults.object(forKey: "NSStatusItem VisibleCC tokenbar-merged") == nil)
    ...
    func `non destructive visibility refresh preserves split provider status items`() throws {
        ...
        #expect(!newCodexItem.autosaveName.hasPrefix("TokenBar."))
