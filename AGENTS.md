...
- Package locally: `./Scripts/package_app.sh` to refresh `TokenBar.app`, then restart with `pkill -x TokenBar || pkill -f TokenBar.app || true; cd /Users/sunny/本地文件/TokenBar && open -n /Users/sunny/本地文件/TokenBar/TokenBar.app`.
...
- To guarantee the right bundle is running after a rebuild, use: `pkill -x TokenBar || pkill -f TokenBar.app || true; cd /Users/sunny/本地文件/TokenBar && open -n /Users/sunny/本地文件/TokenBar/TokenBar.app`.
