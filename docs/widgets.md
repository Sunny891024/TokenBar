...
WIDGET_ID="com.tokenbar.tokenbar.widget" # debug builds use com.tokenbar.tokenbar.debug.widget
...
codesign --verify --strict --verbose=4 "$WAPPEX/Contents/MacOS/TokenBarWidget"
...
- Widget bundle id should be `com.tokenbar.tokenbar.widget` for release and `com.tokenbar.tokenbar.debug.widget` for debug.
