...
- Cached cookies: Keychain cache `com.tokenbar.tokenbar.cache` (account `cookie.claude`, source + timestamp).
...
- Cache:
  - Native + merged provider cache: `~/Library/Caches/TokenBar/cost-usage/claude-v2.json`
