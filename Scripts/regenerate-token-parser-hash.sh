...
SOURCE_DIR="${ROOT_DIR}/Sources/TokenBarCore/Vendored/CostUsage"
OUTPUT_FILE="${ROOT_DIR}/Sources/TokenBarCore/Generated/CodexParserHash.generated.swift"
MODE="${1:-write}"
...
if [[ "$CHECK_ONLY" -eq 1 ]]; then
  ...
  if ! cmp -s "$EXPECTED_FILE" "$OUTPUT_FILE"; then
    echo "error: ${OUTPUT_FILE#${ROOT_DIR}/} is stale. Run Scripts/regenerate-token-parser-hash.sh and commit the result." >&2
