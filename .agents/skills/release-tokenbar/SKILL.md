...
If widget metadata generation times out, `TOKENBAR_WIDGET_METADATA_TIMEOUT_SECONDS=600` is a known-good floor.
...
python3 .github/scripts/update_formula.py --formula tokenbar --tag v<VERSION> --repository steipete/TokenBar --artifact-template 'TokenBarCLI-{tag}-{target}.tar.gz' --target-aliases 'darwin_arm64=macos-arm64,darwin_amd64=macos-x86_64,linux_arm64=linux-aarch64,linux_amd64=linux-x86_64'
